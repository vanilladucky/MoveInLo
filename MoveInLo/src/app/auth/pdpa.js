...
import { Checkbox, FlatList, HStack, ScrollView } from "native-base";
    ...
    <ScrollView>
      <View className={"h-full w-full items-center"}>
        ...
        <View className={"w-5/6 mt-16"}>
          ...
          <Text
            className={"text-justify mt-4 font-RobotoRegular tracking-wide"}
          >
            ...
            to a contract) has been terminated or altered in any way, for a
            reasonable period thereafter (including, where applicable, a period
